  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Privacy Policy) refers to Arbitrary.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Arbitrary, accessible from{" "}
            <a
              href="https://arbitrary.com"
      ...
      <ul>
        ...
        <li>Instagram username (used solely for task verification purposes)</li>
        <li>
          Facebook profile data received via Facebook Login, including your
          name, email address, and profile picture, as permitted by
          Facebook&apos;s platform policies
        </li>
        <li>
          Task activity data, including completed tasks, earned points, and
          engagement history within the Service
        </li>
      </ul>
      <h4>Usage Data</h4>
      ...
      <h4>Third-Party Platform Data</h4>
      <p>
        When You connect a third-party platform account to our Service, We may
        collect the following data as authorized by You:
      </p>
      <ul>
        <li>
          <strong>Facebook:</strong> Public profile information (name, email,
          profile picture) obtained via Facebook Login. We do not access your
          friends list, messages, or any data beyond what you explicitly
          authorize.
        </li>
        <li>
          <strong>Instagram:</strong> Your Instagram username, used only to
          verify task completion. We do not store posts, followers, messages, or
          any other Instagram content.
        </li>
      </ul>
      <p>
        You may revoke platform access at any time through your account settings
        or directly via the respective platform&apos;s app permissions page.
      </p>
      ...
      <ul>
        <li>By email: arbitrary123@gmail.com</li>
      </ul>
    </main>
  );
}
