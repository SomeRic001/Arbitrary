...
const ResetPasswordPage = () => {
  ...
  const passwordToggle = (
    <button
      ...
      className="text-gray-400 hover:text-gray-700 transition-colors cursor-pointer p-0.5 w-7 h-7 flex items-center justify-center rounded-lg hover:bg-gray-100"
    >
        ...
        <div className={`relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-t-3xl px-8 pt-8 pb-10 ${mounted ? "float-up" : "opacity-0"}`}>
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs font-semibold uppercase tracking-[0.25em] mt-1">Set new password</p>
            </div>
          </div>
        </div>
        ...
        <div className={`bg-white rounded-b-3xl border border-gray-100 border-t-0 shadow-xl shadow-black/5 px-8 pb-8 ${mounted ? "float-up-2" : "opacity-0"}`}>
          ...
          {isValidating ? (
            ...
            <div className="text-center space-y-4 pt-4">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Your password has been updated. Sign in with your new password.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-2">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="password" className="text-[10px] font-bold tracking-[0.15em] uppercase text-gray-500">
                  New Password
                </label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    className="w-full py-3 pl-10 pr-10 text-sm rounded-xl bg-gray-50 border border-gray-200 text-gray-900 placeholder:text-gray-400 hover:border-gray-300 focus:outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-900/8 focus:bg-white transition-all duration-150 caret-slate-900"
                  />
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="confirmPassword" className="text-[10px] font-bold tracking-[0.15em] uppercase text-gray-500">
                  Confirm Password
                </label>
                <div className="relative group">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-slate-700 pointer-events-none flex items-center transition-colors duration-150">
