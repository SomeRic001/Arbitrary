    ...
    return (
        <div>
            <style>{`
                ...
                .rise3 { animation: riseUp 0.5s cubic-bezier(0.22,1,0.36,1) 0.16s forwards; opacity: 0; }
            `}</style>
            ...
            <div className="my-8 h-px" style={{
                background: "linear-gradient(90deg, rgba(212,43,43,0.4), rgba(212,43,43,0.1) 60%, transparent)",
            }} />
            ...
            <div className={mounted ? "rise2" : "opacity-0"}>
                <div className="rounded-2xl border p-6" style={{
                    ...
                    <div className="flex items-center gap-3 mb-5">
                        <div className="p-2 rounded-lg" style={{ background: "rgba(200,230,60,0.08)" }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c8e63c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: "rgba(200,230,60,0.4)" }}>
                    ...
                    {registration ? (
                        <>
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider mb-4"
                                style={{ background: "rgba(200,230,60,0.08)", border: "1px solid rgba(200,230,60,0.15)", color: "#c8e63c" }}>
                                <span style={{
